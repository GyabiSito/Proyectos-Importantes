...
if (isset($_SESSION['usuario'])) {
    ...
    $stmt = $pdo->prepare('SELECT id,nombre,venta_alquilar,descripcion,tipo,mejoras,ascensor,nro_piso,bano,servicios,cocina,saneamiento,habitaciones,m²,fecha_publicacion,gastos_comunes,disponibilidad FROM propiedad  WHERE nombre LIKE "%":nombre"%" ORDER BY id LIMIT :current_page, :records_per_page');
...
?>
    ...
    <head>
        ...
        <title>Propiedades - BackOffice</title>
            ...
            <section class="registros">
                ...
                <h2 class="titulo">LISTADO DE PROPIEDADES
                    <form action="busquedapropiedad.php" method="get">
                        <input type="search" placeholder="Buscar Propiedad" name="nombre" class="barra">
                            ...
                            <tbody>
                                <?php foreach ($propiedades as $propiedad) : ?>
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <a href="modificarpropiedad.php?id=<?= $propiedad['id'] ?>" class="edit">
