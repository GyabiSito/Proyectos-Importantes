...
<head>
    ...
    <title>Jorge Cabrera - Propiedades</title>
    ...
    <link rel="stylesheet" href="../css/style-propiedades.css">
            ...
            <div class="contenedor">
                ...
                <div class="propiedades-dest-cont">
                    <?php foreach ($propiedades as $propiedad) : ?>
                        <div class="prop-dest">
                            <a id="link-prop" href="propiedad-especifica.php?id=<?= $propiedad['id'] ?>">
                ...
                <div class="read">
                    <div class='pagination'>
                        <?php if ($page > 1) : ?>
                            <a href="propiedades.php?page=<?= $page - 1 ?>">PÁGINA ANTERIOR</i></a>
                        <?php endif; ?>
                        <?php if ($page * $records_per_page < $num_contacts) : ?>
                            <a href="propiedades.php?page=<?= $page + 1 ?>">SIGUIENTE PÁGINA</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
