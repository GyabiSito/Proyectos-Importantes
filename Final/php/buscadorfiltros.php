...
$records_per_page = 12;
$stmt = $pdo->prepare('SELECT  propiedad.id, propiedad.nombre, propiedad.tipo,propiedad.venta_alquilar, propiedad.precio, propiedad.moneda, imagenes.url FROM propiedad JOIN imagenes ON propiedad.id = imagenes.id_propiedades WHERE propiedad.disponibilidad = 1 AND imagenes.destacada = 1 AND propiedad.precio < :precio AND propiedad.tipo = :tipopropiedad AND propiedad.venta_alquilar = :ventaalquiler  ORDER BY propiedad.id ASC LIMIT :current_page, :records_per_page');
$stmt->BindParam(':precio', $_GET['precio']);
$stmt->BindParam(':tipopropiedad', $_GET['tipopropiedad']);
$stmt->BindParam(':ventaalquiler', $_GET['ventaalquiler']);
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Jorge Cabrera - Filtros</title>
    ...
    <header>
        ...
        <nav> 
            ...
            <li><a href="#"><img src="../img/iconos/globo.png"></a></li>
                ...
                <li class="otro">
                    <a href="../paginas/iniciar-sesion.html">
        ...
        <section class="filtros">
            <div id="generalbuscador">
                ...
                <div class="cont-formu">
                    <form action="buscadorfiltros.php" method="get">
            ...
            <div class="contenedor">
                ...
                <div class="read">
                    <div class='pagination'>
                        <?php if ($page > 1) : ?>
                            <a href="buscadorfiltros.php?page=<?= $page - 1 ?>">PÁGINA ANTERIOR</i></a>
                        <?php endif; ?>
                        <?php if ($page * $records_per_page < $num_contacts) : ?>
                            <a href="buscadorfiltros.php?page=<?= $page + 1 ?>">SIGUIENTE PÁGINA</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
