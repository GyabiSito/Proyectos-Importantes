...
<head>
    ...
    <title>Propiedad - Apartamentos - Gestión Inmobiliaría</title>
    ...
    <header>
        ...
        <nav>
            ...
            <li class="hover"><a href="#"><img src="../../img/iconos/globo.png"></a></li>
                ...
                <ul>
                        <li class="hover"><a href="apartamento.php">APARTAMENTOS</a></li>
                        <li class="hover"><a href="campos.php">CAMPOS</a></li>
                        <li class="hover"><a href="casas.php">CASAS</a></li>
                        <li class="hover"><a href="terrenos.php">TERRENOS</a></li>
                    </ul>
                </li class="hover">
    ...
    <main>
        <section class="contenedor-prpiedades-destacadas">
            <div class="contenedor">
                <h2 class="titulos">APARTAMENTOS</h2>
                ...
                <div class="read">
                    <div class='pagination'>
                        <?php if ($page > 1) : ?>
                            <a href="apartamento.php?page=<?= $page - 1 ?>">PÁGINA ANTERIOR</i></a>
                        <?php endif; ?>
                        <?php if ($page * $records_per_page < $num_contacts) : ?>
                            <a href="apartamento.php?page=<?= $page + 1 ?>">SIGUIENTE PÁGINA</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
