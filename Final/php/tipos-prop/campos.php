            ...
            <div class="contenedor">
                ...
                <div class="read">
                    <div class='pagination'>
                        <?php if ($page > 1) : ?>
                            <a href="campos.php?page=<?= $page - 1 ?>">PÁGINA ANTERIOR</i></a>
                        <?php endif; ?>
                        <?php if ($page * $records_per_page < $num_contacts) : ?>
                            <a href="campos.php?page=<?= $page + 1 ?>">SIGUIENTE PÁGINA</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
